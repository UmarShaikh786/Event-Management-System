...
$date = "$today[year]-$today[mon]-$today[mday]";
   ...
   $sql="insert into Servicebooking(Uname,Sname,Sprice,date,Status,Payment,paymentid,UId)values('$name','$service',$price,'$date','Active','$html','$pid',$uid)";
...
<body style="font-family:sans-serif;">
    <div class="container">
        ...
        <div class="text-container">
            ...
            <div>Click the button below, if you are not redirected to the website.</div><a class="primary-button" href="../fpdf184/pdf1.php">Download Bill</a>
        </div>
    </div>
</body>
