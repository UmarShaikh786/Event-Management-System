...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="content">
        ...
        <div class="input-box" style="margin-left:0px;margin-top:0px;">
            ...
            <input type="file" placeholder="Upload Image" id="file" value="Browse" required>
          </div>
          
           
        <div class="buttonreg" style="margin-left:350px;margin-top:-70px;">
...
//show data
$sql="select * from Gallery order by Gid asc";
...
<?php
			...
			<tr style="text-align:justify;"><td><?php echo $rec['Gid'] ?></td>
      <td><?php echo "<img src='../".$rec['Path']."' height='80' width='100' >"; ?></td>

							
      <td>
      <button type="button"  class="btn btn-primary"  onclick="submitData('update',<?php echo $rec['Gid'] ?>);">update</button> </td>

      <td><button type ="button" class="btn btn-danger" onclick="submitData('delete',<?php echo $rec['Gid'] ?>);">Delete</button> </td>
						</tr>
			<?php
			}
