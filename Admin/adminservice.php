...
<script type="text/javascript">
  function submitData(action,id){
    ...
    <div class="content">
        ...
        <div class="input-box" style="margin-left:0px;margin-top:0px;">
          ...
          <div class="input-box" style="margin-left:250px;margin-top:-95px">
            ...
            <input type="text" placeholder="Enter New Service" id="service" required>
          </div>
          
          <div class="input-box" style="margin-left:500px;margin-top:-95px">
            <span class="details">Service Price</span>
            <input type="text" placeholder="Enter Service Price" id="price" required>
          </div>
          <div class="input-box" style="margin-left:750px;margin-top:-95px;">
            <span class="details">Description</span>
            <textarea id="desc" rows="100" cols="50" placeholder="Enter Service Description" required></textarea>
          </div>
...
<?php
			...
			<tr style="text-align:justify;"><td><?php echo $rec['Sid'] ?></td>
							<td><?php echo "<img src='../".$rec['Sphoto']."' height='80' width='100' >"; ?></td>
							<td><?php echo $rec['Sname'] ?></td>
              <td><?php echo $rec['Sprice'] ?></td>
              <td><?php echo $rec['Sdesc'] ?></td>
                           
             <td> <button type="button"  class="btn btn-primary"  onclick="submitData('update',<?php echo $rec['Sid'] ?>);">update</button> </td>

      <td><button type ="button" class="btn btn-danger" onclick="submitData('delete',<?php echo $rec['Sid'] ?>);">Delete</button> </td>
