    ...
    <div class="content">
      <div class="user-details">
        <div class="input-box" style="margin-left:0px;margin-top:0px;">
          ...
          <input type="file"  value="Browse" id="file" required>
        </div>

        <div class="input-box" style="margin-left:250px;margin-top:-95px">
          <span class="details">Event Name</span>
          <input type="text" placeholder="Enter New Event" id="name" required>
        </div>

        <div class="input-box" style="margin-left:500px;margin-top:-95px;">
          <span class="details">Description</span>
          <textarea rows="100" cols="50" placeholder="Enter Event Description" id="desc" required></textarea>
        </div>

        <div class="form-group" style="margin-left:1050px;margin-top:-70px;">
...
<table class="table table-striped  table-hover table-bordered table align-middle">
  ...
  while ($rec = mysqli_fetch_row($rs)) {
    ...
    <tr style="text-align:justify;">
      ...
      <td>
        <?php echo "<img src='../" . $rec[3] . "' height='80' width='100' >"; ?>
      </td>
      <td>
        <?php echo $rec[1] ?>
      </td>
      ...
      <td>
      <button type="button"  class="btn btn-primary"  onclick="submitData('update',<?php echo $rec[0] ?>);">update</button> </td>
